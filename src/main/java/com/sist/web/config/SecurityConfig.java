...
public class SecurityConfig {
	...
	public JdbcUserDetailsManager jdbcUserDetailsService() {
		...
		manager.setUsersByUsernameQuery(
				"SELECT userid as username,userpwd as password,enabled " + "FROM project_member_2 WHERE userid=?");
		manager.setAuthoritiesByUsernameQuery(
				"SELECT userid as username , authority " + "FROM authority_2 WHERE userid=?");
		return manager;
	}
