					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="single-post wow fadeInUp" data-wow-delay="0.1s">
							...
							<div class="post-thumb">
								<a href="/jeju/detail_before?contentid=${vo.contentid }"> <img
							...
							<ul class="pagination">
								<c:if test="${startPage>1 }">
									<li class="page-item"><a class="page-link"
										href="/jeju/list?page=${startPage-1 }&cno=${cno}">이전 <i
											class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
								</c:if>

								<c:forEach var="i" begin="${startPage }" end="${endPage }">
									<li class="page-item ${i==curpage?'active':''}"><a
										class="page-link" href="/jeju/list?page=${i }&cno=${cno}">${i}</a>
									</li>
								</c:forEach>

								<c:if test="${endPage<totalpage }">
									<li class="page-item"><a class="page-link"
										href="/jeju/list?page=${endPage+1 }&cno=${cno}">다음 <i
