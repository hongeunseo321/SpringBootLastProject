				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-post wow fadeInUp" data-wow-delay="0.1s">
						...
						<div class="post-thumb">
							<a href="/seoul/list_detail_before?cno=${cno }">
						...
						<nav aria-label="#">
							<ul class="pagination">
								<c:if test="${startPage>1 }">
									<li class="page-item"><a class="page-link" href="/seoul/list?page=${startPage-1 }&cno=${cno}">
								...
								<c:if test="${endPage<totalpage }">
									<li class="page-item"><a class="page-link" href="/seoul/list?page=${endPage+1 }&cno=${cno}">다음
