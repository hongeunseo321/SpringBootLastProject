					...
					<form id="frm" ref="frm" method="post" action="/member/join_ok">
						<table class="table table-bordered table-hover">
							<tr>
								...
								<td>
									<div class="form-inline">
										...
										<button type="button" class="btn btn-mint btn-sm"
											@click="idCheck()">중복체크</button>
							...
							<tr>
								...
								<td>
									<div class="form-inline">
										<input type="password" v-model="userpwd" name="userpwd"
											ref="userpwd" class="form-control input-sm"
											placeholder="비밀번호"> <input type="password"
											v-model="userpwd2" name="userpwd2" ref="userpwd2"
											class="form-control input-sm" placeholder="비밀번호 재입력">
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="username" ref="username"
									v-model="username" class="form-control input-sm"
							...
							<tr>
								...
								<td><label class="radio-inline"><input type="radio"
										name="sex" value="남자" checked> 남자</label> <label
							...
							<tr>
								...
								<td><input type="date" name="birthday" ref="birthday"
									class="form-control input-sm" v-model="birthday"></td>
							</tr>
								...
								<td>
									<div class="form-inline">
										<input type="text" ref="post" name="post"
											class="form-control input-sm" readonly v-model="post">
										<button type="button" @click="postFind()"
											class="btn btn-pink btn-sm">우편번호검색</button>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" ref="addr1" name="addr1"
									class="form-control input-sm" readonly v-model="addr1"></td>
							</tr>

							<tr>
								<th class="text-center">상세주소</th>
								<td><input type="text" name="addr2"
									class="form-control input-sm" v-model="addr2"></td>
							</tr>
								...
								<td>
									<div class="form-inline">
										<select name="phone1" class="form-control input-sm"
											...
											<option>011</option>
											<option>016</option>
										</select> <input type="text" name="phone2" v-model="phone2"
							...
							<tr>
								...
								<td><textarea rows="5" name="content"
										class="form-control input-sm" placeholder="자기소개를 입력하세요"
