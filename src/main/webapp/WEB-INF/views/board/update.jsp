							...
							<tr>
								<td class="text-center" colspan="2">
									...
									<button class="btn-sm btn-primary"
										onclick="javascript:history.back()" type="button">취소</button>
								</td>
							</tr>
						</tbody>
					</table>
